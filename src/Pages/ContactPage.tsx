        ...
        <div className="min-h-screen bg-lightGray">
            ...
            <div className="rounded-md max-w-4xl m-auto">
                ...
                <div className="mb-8 bg-white shadow-lg rounded text-gray-600 flex">
                    ...
                    <p className="text-center px-2 py-3"><a href=""><FontAwesomeIcon className="text-black text-2xl px-2" icon={faComments}></FontAwesomeIcon></a>Use the chat button in the lower right of the screen or by clicking the chat icon in this window to chat with our support in realtime.</p>
                </div>
                ...
                <div className="mb-8 bg-white shadow-lg rounded text-gray-600 flex">
                    <p className="text-center px-3 py-3"><a href="http://localhost:3000/Support"><FontAwesomeIcon className="text-black text-2xl pr-2" icon={faList}></FontAwesomeIcon></a><span className="align-top">Chat and Ticket history can be viewed by logging in to your account and navigating to the <span className="font-bold">Support</span> tab in the profile dropdown or by clicking the history icon in this window.</span></p>
                </div>
            </div>
            <Footer></Footer>
