...
export function UserBanner(props: Props) {
    ...
    return (
        <div className="relative overflow-hidden">
            ...
            <div className="w-full h-24 overflow-hidden blur-md bg-repeat-round bg-[url('https://flowbite.com/docs/images/people/profile-picture-5.jpg')]" onClick={props.onClose}></div>
