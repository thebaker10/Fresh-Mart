            ...
            <div className="flex space-between ">
                ...
                <div className="flex w-1/3 text-right">
                    <div className="grid grid-cols-2 gap-3 flex-auto items-center">
                        ...
                        <button className="px-3 py-2 bg-green text-white text-xs font-bold uppercase rounded" onClick={(event) => addToCart(event)}>{loading ? <FontAwesomeIcon icon={faSpinner} spinPulse={true} color={'white'} size={"1x"} /> : added || isInCart ? "In Cart" : "Add To Cart"}</button>
                    </div>
                </div>
            </div>
