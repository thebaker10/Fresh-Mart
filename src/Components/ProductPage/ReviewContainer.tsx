    ...
    return (
        <div className="mx-auto max-w-5xl mt-10">
            ...
            <div className="flex item-center mt-2">
                ...
                <p className="ml-2">{props.numOfReviews} total reviews</p>
            </div>
            <hr className="mt-2"></hr>
            <Review username={"Nick"} stars={Math.round(Math.random()*5)} date = {"Reviewed on: 9/14/22"} reviewTitle = {"Great product!!!"} review={"Maids table how learn drift but purse stand yet set. Music me house could among oh as their. Piqued our sister shy nature almost his wicket."}></Review>
            ...
            <Review username={"Jane"} stars={Math.round(Math.random()*5)} date = {"Reviewed on: 1/1/22"} reviewTitle = {"Good"} review={"Maids table how learn drift but purse stand yet set. Music me house could among oh as their. Piqued our sister shy nature almost his wicket."}></Review>
        </div>
    )
}